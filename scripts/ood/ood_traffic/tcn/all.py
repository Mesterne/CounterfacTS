...
if __name__ == '__main__':
    ...
    generated_train_trend_str_dec = change_trend_str(train_data, config["sp"], f=0.01)
    ...
    expanded_train = add_to_dataset(expanded_train, generated_train_trend_str_dec)
    ...
    generated_val_trend_str_dec = change_trend_str(validation_data, config["sp"], f=0.01)
    ...
    expanded_val = add_to_dataset(expanded_val, generated_val_trend_str_dec)
