...
from src.utils.transformations import manipulate_seasonal_determination
...
if __name__ == '__main__':
    ...
    generated_train = change_seasonality(train_data, config["sp"], k=0.01)
    expanded_train = add_to_dataset(train_data, generated_train)

    generated_val = change_seasonality(validation_data, config["sp"], k=0.01)
