...
from src.utils.features import extract_trend
...
if __name__ == '__main__':
    ...
    generated_train = change_trend_str(train_data, config["sp"], f=0.01)
    expanded_train = add_to_dataset(train_data, generated_train)

    generated_val = change_trend_str(validation_data, config["sp"], f=0.01)
